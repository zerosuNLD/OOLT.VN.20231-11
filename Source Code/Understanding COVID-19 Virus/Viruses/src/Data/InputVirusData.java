...
public class InputVirusData {
	...
	static GUI_Enveloped_Virus covid = new GUI_Enveloped_Virus(001, "Sars-Covi 2", "Nucleic Acid + Capsid" ,"Enveloped Virus",
			...
			"/Screen/XML/Image/Sars-covi2.jpg",
			"/Screen/XML/Image/Sars-covi2_LifeCycle.jpg",
			"Viruses/src/Data/Video/1.mp4");
	...
	static GUI_Enveloped_Virus hiv = new GUI_Enveloped_Virus(002, "HIV", 
			...
			"/Screen/XML/Image/HIV.jpg",
			"/Screen/XML/Image/hiv_Lifecycle.jpg",
			"Viruses/src/Data/Video/1.mp4");
	...
	static GUI_Non_Enveloped_Virus rhinovirus  = new GUI_Non_Enveloped_Virus(001, "rhinovirus", 
			...
			"Individual", 
			"/Screen/XML/Image/rhinovirus.jpg", "/Screen/XML/Image/rhinovirus_LifeCycle.jpg", "Viruses/src/Data/Video/1.mp4");

	static GUI_Non_Enveloped_Virus norovirus  = new GUI_Non_Enveloped_Virus(002, "norovirus", 
			"Nucleic Acid + Capsid",
			"Non-Enveloped virus",
			"The Rhinovirus is a single-stranded RNA virus with a positive sense, belonging to the Enterovirus genus in the Picornaviridae family. Rhinovirus is the most prevalent infectious agent in humans and is the primary cause of the common cold.",
			...
			"/Screen/XML/Image/Norovirus.jpg", "/Screen/XML/Image/Norovirus_LifeCycle.png", "Viruses/src/Data/Video/1.mp4");
	...
	private static JSONArray addVirusToJsonArray(JSONArray lJsonArray, GUI_Virus... viruslist) {
		for (GUI_Virus gUI_Virus : viruslist) {
			...
			virusDetailObject.put("Infection", gUI_Virus.getInfectionString());
