...
public class InputVirusData {
	...
	static VirusWithLipid covid = new VirusWithLipid(001, "COVID-19", "Nucleic Acid + Capsid", "Virus With Lipit",
			"introduction", "individual", "Image/covid.jpg", "Image/conDuongLayNhiemHiv.jpg","Viruses/src/DataBase/Video/1.mp4");

	static VirusWithLipid rotavirus = new VirusWithLipid(002, "Rotaviruses", "Nucleic Acid + Capsid", "Virus With Lipit",
			"introduction", "individual", "Image/rotaviruses.jpg", "Image/conDuongLayNhiemHiv.jpg","Viruses/src/DataBase/Video/1.mp4");

	static VirusWithoutLipid hiv = new VirusWithoutLipid(001, "HIV", "Nucleic Acid + Capsid", "Virus Without Lipit",
			"Intro", "Infection", "Image/HIV.jpg", "Image/conDuongLayNhiemHiv.jpg", "Viruses/src/DataBase/Video/1.mp4");
	...
	public static void main(String[] args) {
		...
		try (FileWriter file = new FileWriter("Viruses/src/DataBase/VirusWithLipitStore.json")) {
		...
		try (FileWriter file = new FileWriter("Viruses/src/DataBase/VirusWithoutLipitStore.json")) {
